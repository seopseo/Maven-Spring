...
import co.seop.pjt.board.command.BoardInsert;
import co.seop.pjt.board.command.BoardInsertForm;
import co.seop.pjt.board.command.BoardSelect;
import co.seop.pjt.board.command.BoardSelectList;
import co.seop.pjt.comm.Command;
import co.seop.pjt.home.command.HomeCommand;
import co.seop.pjt.member.command.MemberSelect;
import co.seop.pjt.member.command.MemberSelectList;
...
public class FrontController extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		map.put("/memberSelect.do", new MemberSelect()); // 한명을 조회하는 것
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Command command = map.get(page); // HomeCommand를 받는다
